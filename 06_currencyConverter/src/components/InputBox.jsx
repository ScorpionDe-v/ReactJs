...
return (
    <div className={`bg-white p-3 rounded-lg text-sm flex ${className}`}>
        ...
        <select className='rounded-lg px-1 py-1 bg-gray-100 cursor-pointer outline-none' value={selectCurrency} onChange={(e)=>onCurrencyChange && onAmountChange(e.target.value)} disabled={currencyDisable} >
